...
if ( !function_exists('ss_framework_register_styles') ) {
	...
	function ss_framework_register_styles() {
		...
		if( !is_admin() ) {
			...
			wp_register_style( 'jquery-nouislider', get_stylesheet_directory_uri() . '/css/jquery.nouislider.min.css', null, false );
...
if ( !function_exists('ss_framework_register_scripts') ) {
	...
	function ss_framework_register_scripts() {
		...
		if( !is_admin() ) {
			...
			wp_register_script( 'jquery-nouislider', SS_BASE_URL . 'js/jquery.nouislider.min.js',               array('jquery'), false, true );
			...
			wp_register_script( 'smartstart-slider', SS_BASE_URL . 'js/jquery.smartStartSlider.min.js',         array('jquery'), true, false );
