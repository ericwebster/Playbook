...
<?php $has_sidebar = ss_framework_check_page_layout( $single_project = null, $portfolio_tags = true ); ?>

<?php global $wp_query; $category = $wp_query->get_queried_object(); ?>

<section id="content" class="clearfix <?php echo ss_framework_check_sidebar_position( $single_project = null, $portfolio_tags = true ); ?>">
